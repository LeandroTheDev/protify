...
The generated command can be found in protify/data/log or you can click on the command generated by the log modal to copy it.3
...
- If you are using official protons make sure: ``Steam Compatibility`` option is enabled
- Confirm and play the game to test
